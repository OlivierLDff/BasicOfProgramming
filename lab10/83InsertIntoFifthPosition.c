...
void l_t_insert_fifth(l_t * this, char * s)
{
	l_t * it = this;
	size_t cnt = 0;
	while (it && it->nxt)
...
int main(void) 
{
	...
	l_t_insert_fifth(firstArray, toinsert);
	l_t_insert_fifth(secondArray, toinsert);
